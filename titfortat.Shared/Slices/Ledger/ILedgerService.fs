...
type ILedgerService =
    ...
    abstract member GetSpendingTokenEventsInATimeInterval: context: UserContext * ledgerId: LedgerId *  dateFrom: DateTime * dateTo: DateTime * ?ct: CancellationToken -> Task<Result<List<CoopId*UserId*DateTime>, string>>
